...
$mail->Subject = 'Appointment accept from student';
//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
// $mail->msgHTML(file_get_contents('content.html'), dirname(__FILE__));
$mail->msgHTML("นักศึกษาตอบรับคำขอนัดหมายของคุณแล้ว กรุณาไปที่เว็บไซต์ http://www.encm.rmutt.ac.th/informationsearch/index.php?p=appointment หรือเมนูจัดการรายการนัดหมายเพื่อดำเนินการต่อไป");
$mail->send();
